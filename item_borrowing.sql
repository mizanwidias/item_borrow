...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2025 at 12:19 PM
...
ALTER TABLE `borrowings`
  ...
  ADD CONSTRAINT `borrowings_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `items` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
